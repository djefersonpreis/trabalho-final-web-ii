...
Route::get('/grupos/remove/{grupo_id}', [TodoGrupoController::class, 'remove'])     ->name('grupos.remove')->where('produto_id', '[0-9]+');
Route::get('/grupos/edit/{grupo_id}',   [TodoGrupoController::class, 'edit'])       ->name('grupos.edit')  ->where('produto_id', '[0-9]+');
